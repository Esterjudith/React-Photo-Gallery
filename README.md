...
* The user can click on the any image in the gallery and it will enlarge into a slide with a larger view of the image and with a click the user may see the next or previous image on the slide. 
